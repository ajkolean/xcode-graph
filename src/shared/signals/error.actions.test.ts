...
describe('error.actions', () => {
  ...
  it('clearErrorsBySeverity removes matching severity', () => {
    addError(makeError({ id: 'e1', severity: 'error' }));
    addError(makeError({ id: 'e2', severity: 'warning' }));
  ...
  it('clearErrorsByCategory removes matching category', () => {
    addError(makeError({ id: 'e1', category: 'data' }));
    addError(makeError({ id: 'e2', category: 'network' }));
