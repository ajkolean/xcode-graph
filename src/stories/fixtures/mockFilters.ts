 ...
 */
export const fewFilterItems: FilterItem[] = [
 ...
 */
export const emptyFilterItems: FilterItem[] = [];

/**
 * Get filter items with zero counts
 */
export const zeroCountFilters: FilterItem[] = [
 ...
 */
export const highCountFilters: FilterItem[] = [
