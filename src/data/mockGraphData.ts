...
function generateMockData(): GraphData {
  ...
  tuistCoreTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'local',
    project: 'TuistCore'
  ...
  tuistKitTargets.forEach(t => nodes.push({
    ...t,
    platform: 'macOS',
    origin: 'local',
    project: 'TuistKit'
  ...
  featureKitTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'local',
    project: 'FeatureKit'
  ...
  uiKitTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'local',
    project: 'UIKit'
  ...
  networkKitTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'local',
    project: 'NetworkKit'
  ...
  dataKitTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'local',
    project: 'DataKit'
  ...
  const appTargets = [
    ...
    { id: 'app-ui-tests', name: 'MainAppUITests', type: 'test-ui' as const, platform: 'iOS' as const }
  ];
  
  appTargets.forEach(t => nodes.push({
    id: t.id,
    name: t.name,
    type: t.type,
    platform: t.platform,
  ...
  utilsKitTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'local',
    project: 'UtilsKit'
  ...
  alamofireTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'Alamofire'
  ...
  navigationTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
  ...
  loggingTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'SwiftLog'
  ...
  kingfisherTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'Kingfisher'
  ...
  snapkitTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'SnapKit'
  ...
  combineTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'CombineExt'
  ...
  protobufTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
  ...
  nimbleTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'Nimble'
  ...
  quickTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'Quick'
  ...
  firebaseTargets.forEach(t => nodes.push({
    ...t,
    platform: 'iOS',
    origin: 'external',
    project: 'Firebase'
