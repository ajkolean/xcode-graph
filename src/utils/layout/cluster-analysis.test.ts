...
describe('clusterAnalysis', () => {
  describe('identifyAnchors', () => {
    it('should prioritize app nodes as anchors', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'app1', name: 'MyApp', type: 'app' }),
        createNode({ id: 'lib1', name: 'MyLib', type: 'library' }),
        createNode({ id: 'fw1', name: 'MyFramework', type: 'framework' }),
      ];
    ...
    it('should prioritize CLI nodes when no apps', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'cli1', name: 'MyCLI', type: 'cli' }),
        createNode({ id: 'lib1', name: 'MyLib', type: 'library' }),
      ];
      const dependents = new Map<string, Set<string>>([
        ['cli1', new Set()],
    ...
    it('should use framework with external dependents when no apps/CLIs', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'fw1', name: 'PublicFramework', type: 'framework' }),
        createNode({ id: 'fw2', name: 'InternalFramework', type: 'framework' }),
        createNode({ id: 'lib1', name: 'MyLib', type: 'library' }),
      ];
      const dependents = new Map<string, Set<string>>([
        ['fw1', new Set()],
    ...
    it('should fall back to most depended-upon node', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'lib1', name: 'Lib1', type: 'library' }),
        createNode({ id: 'lib2', name: 'Lib2', type: 'library' }),
        createNode({ id: 'lib3', name: 'Lib3', type: 'library' }),
      ];
      const dependents = new Map<string, Set<string>>([
    ...
    it('should return all apps when multiple apps exist', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'app1', name: 'App1', type: 'app' }),
        createNode({ id: 'app2', name: 'App2', type: 'app' }),
      ];
      const dependents = new Map<string, Set<string>>([
        ['app1', new Set()],
        ['app2', new Set()],
  ...
  describe('assignLayers', () => {
    it('should assign layer 0 to anchors', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'anchor', name: 'Anchor', type: 'app' }),
        createNode({ id: 'dep1', name: 'Dep1', type: 'library' }),
      ];
    ...
    it('should assign higher layers to non-anchors', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'anchor', name: 'Anchor', type: 'app' }),
        createNode({ id: 'dep1', name: 'Dep1', type: 'library' }),
        createNode({ id: 'dep2', name: 'Dep2', type: 'library' }),
      ];
      const anchors = [nodes[0]];
      const dependencies = new Map<string, Set<string>>([
        ['anchor', new Set(['dep1'])],
    ...
    it('should exclude test nodes from layer assignment', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'anchor', name: 'Anchor', type: 'app' }),
        createNode({ id: 'test1', name: 'Test1', type: 'test-unit' }),
      ];
      const anchors = [nodes[0]];
  ...
  describe('determineRole', () => {
    it('should return test for test nodes', () => {
      const node = createNode({ id: 'test', name: 'Test', type: 'test-unit' });
    ...
    it('should return entry for anchor nodes', () => {
      const node = createNode({ id: 'app', name: 'App', type: 'app' });
    ...
    it('should return tool for CLI nodes', () => {
      const node = createNode({ id: 'cli', name: 'CLI', type: 'cli' });
    ...
    it('should return internal-framework for framework nodes', () => {
      const node = createNode({ id: 'fw', name: 'Framework', type: 'framework' });
      const role = determineRole(node, false, false, 0);
    ...
    it('should return internal-lib for library with 2+ dependents', () => {
      const node = createNode({ id: 'lib', name: 'Library', type: 'library' });
  ...
  describe('analyzeCluster', () => {
    ...
    it('should identify anchors and populate metadata', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'app', name: 'App', type: 'app' }),
    ...
    it('should assign roles to all nodes', () => {
      const nodes: GraphNode[] = [
        createNode({ id: 'app', name: 'App', type: 'app' }),
        createNode({ id: 'fw', name: 'Framework', type: 'framework' }),
        createNode({ id: 'test', name: 'Test', type: 'test-unit' }),
      ];
