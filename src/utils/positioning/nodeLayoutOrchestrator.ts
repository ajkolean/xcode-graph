...
export function layoutClusterNodes(
  ...
  layers.forEach((layer) => {
    ...
    const layerPositions = positionNodesInLayer(layer, nodesInLayer, cluster, config);
 ...
 */
function groupNodesByLayer(nodes: GraphNode[], cluster: Cluster): Map<number, GraphNode[]> {
