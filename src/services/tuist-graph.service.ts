 ...
 */
export function transformTuistGraph(raw: unknown): TransformResult {
...
export async function loadTuistGraph(jsonPath: string): Promise<TransformResult> {
...
export function parseTuistGraph(jsonString: string): TransformResult {
