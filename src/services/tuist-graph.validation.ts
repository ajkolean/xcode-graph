/**
 * Tuist Graph Boundary Validation
 *
 * Lenient Zod schema that validates the minimal required shape of raw Tuist
 * graph JSON without being strict about every field. Uses z.looseObject()
 * so unknown fields pass through, allowing forward-compatibility when
 * XcodeGraph adds new fields or enum values.
 *
 * @module services/tuist-graph.validation
 */
