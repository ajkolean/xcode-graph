...
```yaml
- generic [ref=e2]:
  - 'heading "Failed to fetch dynamically imported module: http://localhost:6006/.storybook/preview.ts?t=1764207801684" [level=1] [ref=e3]'
  ...
  - list [ref=e5]:
    ...
    - listitem [ref=e13]:
      ...
      - text: .
  - code [ref=e17]: "TypeError: Failed to fetch dynamically imported module: http://localhost:6006/.storybook/preview.ts?t=1764207801684"
```