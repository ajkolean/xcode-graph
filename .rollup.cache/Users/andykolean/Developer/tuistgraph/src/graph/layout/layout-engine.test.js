...
import { createLayeredGraph, createMultiClusterGraph, createProjectGraph, } from '../../fixtures/graphs';
import { computeHierarchicalLayout } from './index';
/**
 * Helper to create clusters from nodes based on their project property
 */
function createClustersFromGraph(nodes, _edges) {
...
describe('computeHierarchicalLayout', () => {
    ...
    describe('Node Positioning Within Clusters', () => {
        function assertNodesWithinCluster(cluster, result) {
...
//# sourceMappingURL=layout-engine.test.js.map