 ...
 */
export function computeClusterInterior(cluster, config) {
    ...
    const simulation = d3
        ...
        .force('collide', d3.forceCollide().radius((d) => d.radius + config.nodeCollisionPadding))
...
//# sourceMappingURL=micro-layout.js.map