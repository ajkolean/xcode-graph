...
export class GraphClusterCard extends LitElement {
    ...
    computeCardStyles(props, zoomAdjustedColor) {
...
], GraphClusterCard.prototype, "cluster", void 0);
__decorate([
    property({ type: Number })
], GraphClusterCard.prototype, "x", void 0);
__decorate([
    property({ type: Number })
], GraphClusterCard.prototype, "y", void 0);
__decorate([
    property({ type: Number })
], GraphClusterCard.prototype, "width", void 0);
__decorate([
    property({ type: Number })
], GraphClusterCard.prototype, "height", void 0);
__decorate([
    property({ type: Boolean, attribute: 'is-highlighted' })
], GraphClusterCard.prototype, "isHighlighted", void 0);
__decorate([
    property({ type: Boolean, attribute: 'is-dimmed' })
], GraphClusterCard.prototype, "isDimmed", void 0);
__decorate([
    property({ type: Boolean, attribute: 'is-selected' })
], GraphClusterCard.prototype, "isSelected", void 0);
__decorate([
    property({ type: Number })
], GraphClusterCard.prototype, "zoom", void 0);
__decorate([
    property({ type: Boolean })
], GraphClusterCard.prototype, "clickable", void 0);
// Register custom element with HMR support
if (!customElements.get('xcode-graph-cluster-card')) {
    customElements.define('xcode-graph-cluster-card', GraphClusterCard);
}
//# sourceMappingURL=cluster-card.js.map