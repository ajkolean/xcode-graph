...
import './graph-edges';
import { createMediumTestGraph, createMockClusterPositions, createMockNodePositions, createSmallTestGraph, createTransitiveResult, } from './test-helpers/graph-fixtures';
...
describe('xcode-graph-edges', () => {
    ...
    `);
        const edgesComponent = svgEl.querySelector('xcode-graph-edges');
...
//# sourceMappingURL=graph-edges.test.js.map