...
import { createLargeTestGraph, createMockNodePositions, createNodeInViewport, createNodeOutsideViewport, createViewportBounds, } from './test-helpers/graph-fixtures';
describe('xcode-graph-virtual-renderer', () => {
    it('should accept viewport dimensions', async () => {
        const el = await fixture(html `<xcode-graph-virtual-renderer
        viewportWidth="1920"
        viewportHeight="1080"
...
//# sourceMappingURL=virtual-renderer.test.js.map