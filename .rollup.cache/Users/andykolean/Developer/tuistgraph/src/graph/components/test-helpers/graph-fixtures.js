 ...
 */
export function createMockNodePositions(nodeIds) {
 ...
 */
export function createMockClusterPositions(clusterIds) {
    const positions = new Map();
 ...
 */
export function createMockClusters(nodes) {
 ...
 */
export function createTestEdge(source = 'node1', target = 'node2') {
    return { source, target };
}
/**
 * Create transitive dependency result (for view mode testing)
 */
export function createTransitiveResult(nodeIds, edgeKeys) {
...
export function createViewportBounds(width = 1000, height = 800, panX = 0, panY = 0, zoom = 1) {
    return {
        minX: -panX / zoom,
        minY: -panY / zoom,
 ...
 */
export function createNodeInViewport(id, viewport) {
 ...
 */
export function createNodeOutsideViewport(id, viewport) {
