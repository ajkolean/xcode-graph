...
// Node Positions
// ========================================
export const mockNodePositions = new Map([
...
// Cluster Positions
// ========================================
export const mockClusterPositions = new Map([
    [
        'main-app',
        {
            id: 'main-app',
...
export function getNodePosition(nodeId) {
    return (mockNodePositions.get(nodeId) || {
        id: nodeId,
        x: 400,
        y: 300,
        vx: 0,
 ...
 */
export function getClusterPosition(clusterId) {
    return (mockClusterPositions.get(clusterId) || {
        id: clusterId,
        x: 400,
        y: 300,
        vx: 0,
