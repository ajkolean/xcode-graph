...
function addTargetsToNodes(nodes, targets, defaults) {
...
function generateMockData() {
    ...
    { source: 'tuistcore-main', target: 'tuistcore-graph' }, { source: 'tuistcore-main', target: 'tuistcore-loader' }, { source: 'tuistcore-main', target: 'tuistcore-generator' }, { source: 'tuistcore-main', target: 'tuistcore-support' }, { source: 'tuistcore-graph', target: 'tuistcore-support' }, { source: 'tuistcore-loader', target: 'tuistcore-support' }, { source: 'tuistcore-generator', target: 'tuistcore-graph' }, { source: 'tuistcore-signing', target: 'tuistcore-main' }, { source: 'tuistcore-dependencies', target: 'tuistcore-main' }, { source: 'tuistcore-migration', target: 'tuistcore-loader' }, 
    // TuistCore tests
    { source: 'tuistcore-tests', target: 'tuistcore-main' }, { source: 'tuistcore-graph-tests', target: 'tuistcore-graph' }, { source: 'tuistcore-loader-tests', target: 'tuistcore-loader' }, { source: 'tuistcore-generator-tests', target: 'tuistcore-generator' }, { source: 'tuistcore-ui-tests', target: 'tuistcore-main' }, { source: 'tuistcore-acceptance', target: 'tuistcore-main' }, { source: 'tuistcore-integration', target: 'tuistcore-main' }, 
    // TuistKit internal dependencies
    { source: 'tuistkit-main', target: 'tuistcore-main' }, { source: 'tuistkit-main', target: 'tuistkit-automation' }, { source: 'tuistkit-main', target: 'tuistkit-cloud' }, { source: 'tuistkit-main', target: 'tuistkit-caching' }, { source: 'tuistkit-cli', target: 'tuistkit-main' }, { source: 'tuistkit-automation', target: 'tuistcore-main' }, { source: 'tuistkit-cloud', target: 'tuistcore-main' }, { source: 'tuistkit-caching', target: 'tuistcore-main' }, { source: 'tuistkit-plugin', target: 'tuistcore-main' }, { source: 'tuistkit-scaffold', target: 'tuistcore-loader' }, { source: 'tuistkit-analytics', target: 'tuistkit-cloud' }, 
    // TuistKit tests
    { source: 'tuistkit-tests', target: 'tuistkit-main' }, { source: 'tuistkit-cloud-tests', target: 'tuistkit-cloud' }, { source: 'tuistkit-integration', target: 'tuistkit-main' }, { source: 'tuistkit-e2e', target: 'tuistkit-cli' }, 
    // FeatureKit dependencies
    { source: 'featurekit-home', target: 'uikit-main' }, { source: 'featurekit-home', target: 'networkkit-main' }, { source: 'featurekit-home', target: 'datakit-main' }, { source: 'featurekit-profile', target: 'uikit-main' }, { source: 'featurekit-profile', target: 'datakit-main' }, { source: 'featurekit-settings', target: 'uikit-main' }, { source: 'featurekit-settings', target: 'datakit-main' }, { source: 'featurekit-auth', target: 'networkkit-main' }, { source: 'featurekit-auth', target: 'datakit-keychain' }, { source: 'featurekit-auth', target: 'firebase-auth' }, { source: 'featurekit-onboarding', target: 'uikit-main' }, 
    // FeatureKit tests
    { source: 'featurekit-home-tests', target: 'featurekit-home' }, { source: 'featurekit-profile-tests', target: 'featurekit-profile' }, { source: 'featurekit-settings-tests', target: 'featurekit-settings' }, { source: 'featurekit-auth-tests', target: 'featurekit-auth' }, { source: 'featurekit-ui-tests', target: 'featurekit-home' }, { source: 'featurekit-ui-tests', target: 'featurekit-profile' }, 
    // UIKit dependencies
    { source: 'uikit-main', target: 'uikit-components' }, { source: 'uikit-main', target: 'uikit-designsystem' }, { source: 'uikit-main', target: 'uikit-resources' }, { source: 'uikit-components', target: 'uikit-designsystem' }, { source: 'uikit-components', target: 'snapkit-main' }, { source: 'uikit-animations', target: 'uikit-main' }, { source: 'uikit-designsystem', target: 'uikit-resources' }, 
    // UIKit tests
    { source: 'uikit-tests', target: 'uikit-main' }, { source: 'uikit-snapshot', target: 'uikit-components' }, { source: 'uikit-accessibility', target: 'uikit-main' }, 
    // NetworkKit dependencies
    { source: 'networkkit-main', target: 'networkkit-api' }, { source: 'networkkit-main', target: 'networkkit-models' }, { source: 'networkkit-api', target: 'alamofire-main' }, { source: 'networkkit-api', target: 'combine-ext' }, { source: 'networkkit-websocket', target: 'networkkit-models' }, { source: 'networkkit-websocket', target: 'alamofire-main' }, { source: 'networkkit-models', target: 'protobuf-main' }, { source: 'networkkit-mocks', target: 'networkkit-api' }, 
    // NetworkKit tests
    { source: 'networkkit-tests', target: 'networkkit-main' }, { source: 'networkkit-tests', target: 'nimble-main' }, { source: 'networkkit-tests', target: 'quick-main' }, { source: 'networkkit-integration', target: 'networkkit-api' }, 
    // DataKit dependencies
    { source: 'datakit-main', target: 'datakit-core' }, { source: 'datakit-main', target: 'datakit-cache' }, { source: 'datakit-main', target: 'datakit-keychain' }, { source: 'datakit-main', target: 'datakit-userdefaults' }, { source: 'datakit-core', target: 'datakit-models' }, { source: 'datakit-cache', target: 'datakit-models' }, { source: 'datakit-models', target: 'protobuf-main' }, 
    // DataKit tests
    { source: 'datakit-tests', target: 'datakit-main' }, { source: 'datakit-migration-tests', target: 'datakit-core' }, { source: 'datakit-performance', target: 'datakit-cache' }, 
    // App dependencies
    { source: 'app-ios', target: 'featurekit-home' }, { source: 'app-ios', target: 'featurekit-profile' }, { source: 'app-ios', target: 'featurekit-settings' }, { source: 'app-ios', target: 'featurekit-auth' }, { source: 'app-ios', target: 'featurekit-onboarding' }, { source: 'app-ios', target: 'uikit-main' }, { source: 'app-ios', target: 'networkkit-main' }, { source: 'app-ios', target: 'datakit-main' }, { source: 'app-ios', target: 'utilskit-main' }, { source: 'app-ios', target: 'firebase-core' }, { source: 'app-ios', target: 'firebase-analytics' }, { source: 'app-ios', target: 'firebase-crashlytics' }, { source: 'app-ios', target: 'firebase-messaging' }, { source: 'app-ios', target: 'nav-main' }, { source: 'app-macos', target: 'tuistkit-main' }, { source: 'app-macos', target: 'utilskit-main' }, 
    // App tests
    { source: 'app-tests', target: 'app-ios' }, { source: 'app-tests', target: 'nimble-main' }, { source: 'app-tests', target: 'quick-main' }, { source: 'app-ui-tests', target: 'app-ios' }, 
    // UtilsKit dependencies
    { source: 'utilskit-main', target: 'utilskit-extensions' }, { source: 'utilskit-main', target: 'utilskit-helpers' }, { source: 'utilskit-main', target: 'utilskit-logger' }, { source: 'utilskit-logger', target: 'logging-main' }, 
    // UtilsKit tests
    { source: 'utilskit-tests', target: 'utilskit-main' }, { source: 'utilskit-performance', target: 'utilskit-main' }, 
    // External package internal dependencies
    { source: 'alamofire-dynamic', target: 'alamofire-main' }, { source: 'alamofire-tests', target: 'alamofire-main' }, { source: 'nav-tests', target: 'nav-main' }, { source: 'logging-tests', target: 'logging-main' }, { source: 'kingfisher-swiftui', target: 'kingfisher-main' }, { source: 'kingfisher-tests', target: 'kingfisher-main' }, { source: 'kingfisher-ui-tests', target: 'kingfisher-main' }, { source: 'snapkit-tests', target: 'snapkit-main' }, { source: 'combine-tests', target: 'combine-ext' }, { source: 'protobuf-plugin', target: 'protobuf-main' }, { source: 'protobuf-tests', target: 'protobuf-main' }, { source: 'quick-tests', target: 'quick-main' }, { source: 'firebase-auth', target: 'firebase-core' }, { source: 'firebase-firestore', target: 'firebase-core' }, { source: 'firebase-analytics', target: 'firebase-core' }, { source: 'firebase-crashlytics', target: 'firebase-core' }, { source: 'firebase-messaging', target: 'firebase-core' }, 
    // Additional cross-project dependencies
    { source: 'tuistkit-cloud', target: 'networkkit-api' }, { source: 'tuistkit-cloud', target: 'alamofire-main' }, { source: 'featurekit-home', target: 'kingfisher-main' }, { source: 'featurekit-profile', target: 'kingfisher-swiftui' }, { source: 'uikit-components', target: 'kingfisher-swiftui' }, { source: 'datakit-main', target: 'firebase-firestore' }, { source: 'networkkit-api', target: 'logging-main' }, { source: 'utilskit-logger', target: 'firebase-crashlytics' });
    return { nodes, edges };
}
export const mockGraphData = generateMockData();
//# sourceMappingURL=largeGraph.js.map