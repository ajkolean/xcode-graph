...
describe('GraphErrorToast', () => {
    ...
    beforeEach(async () => {
        element = await fixture(html `<xcode-graph-error-toast></xcode-graph-error-toast>`);
    });
    describe('Rendering', () => {
    ...
    describe('Action Button', () => {
        ...
        it('should dispatch action event on button click', async () => {
            ...
            const event = (await oneEvent(element, 'action'));
            expect(event).to.exist;
...
//# sourceMappingURL=error-toast.test.js.map