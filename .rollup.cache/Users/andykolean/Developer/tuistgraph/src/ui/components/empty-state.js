...
export class GraphEmptyState extends LitElement {
  ...
  `;
    ...
    render() {
        return { ["_$litType$"]: lit_template_1, values: [this.renderSearchIcon(), this.hasActiveFilters
                    ? { ["_$litType$"]: lit_template_2, values: [this.handleClearFilters, this.renderClearIcon()] } : ''] };
    }
}
__decorate([
    property({ type: Boolean, attribute: 'has-active-filters' })
], GraphEmptyState.prototype, "hasActiveFilters", void 0);
