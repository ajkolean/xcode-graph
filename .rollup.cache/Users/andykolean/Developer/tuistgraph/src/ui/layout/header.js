...
const lit_template_1 = { h: b_1 `
    ...
    `, parts: [{ type: 2, index: 14 }, { type: 2, index: 17 }, { type: 2, index: 22 }, { type: 2, index: 25 }, { type: 2, index: 33 }] };
/**
...
export class GraphHeader extends LitElement {
  ...
  `;
    ...
    // ========================================
    render() {
        return { ["_$litType$"]: lit_template_1, values: [this.renderSelectorIcon(), this.renderSlashIcon(), this.renderSelectorIcon(), this.renderSlashIcon(), unsafeHTML(icons.Book)] };
    }
}
