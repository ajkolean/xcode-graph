 ...
 * ```
 */
export function createSignalSnapshot(signals) {
 ...
 * ```
 */
export function restoreSignalSnapshot(snapshot) {
 ...
 * ```
 */
export function resetSignal(signal, value) {
    signal.set(value);
}
/**
 ...
 * ```
 */
export function spyOnSignal(signal) {
    const changes = [];
