...
describe('KeyboardShortcutController', () => {
    ...
    describe('Lifecycle', () => {
        ...
        it('should handle cleanup errors gracefully', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('[KeyboardShortcutController] Error during cleanup:', expect.any(Error));
...
//# sourceMappingURL=keyboard-shortcut.controller.test.js.map