...
import { resetZoom, setActiveTab, setEnableAnimation, setPreviewFilter, setZoom, toggleAnimation, zoomIn, zoomOut, } from './ui.actions';
...
describe('ui.actions', () => {
    ...
    describe('setActiveTab', () => {
        it('should allow switching between tabs', () => {
            const tabs = [ActiveTab.Graph, ActiveTab.Overview];
...
//# sourceMappingURL=ui.actions.test.js.map