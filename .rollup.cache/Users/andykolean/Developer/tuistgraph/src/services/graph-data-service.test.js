...
import { createDiamondGraph, createEmptyGraph, createLinearChain, createNode, createProjectGraph, } from '../fixtures';
...
describe('GraphDataService', () => {
    ...
    describe('getNodesByPlatform', () => {
        ...
        it('should return empty for non-existent platform', () => {
            const nodes = [createNode({ id: '1', name: 'A', platform: Platform.iOS })];
            const service = new GraphDataService(nodes, []);
...
//# sourceMappingURL=graph-data-service.test.js.map