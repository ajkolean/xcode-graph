 ...
 * ```
 */
import { DEFAULT_TOAST_DURATION, ErrorCategory as ErrorCategoryEnum, ErrorSeverity as ErrorSeverityEnum, } from '@shared/schemas/error.types';
...
export class ErrorService {
    ...
    handleError(error, options = {}) {
        const { category = ErrorCategoryEnum.Unknown, severity = ErrorSeverityEnum.Error, userMessage, dismissible = true, actionLabel, actionType, logToConsole = true, autoDismissMs, } = options;
     ...
     * Handle a warning
     */
    handleWarning(message, category) {
     ...
     */
    setupAutoDismiss(errorId, severity, customDurationMs) {
