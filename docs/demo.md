...
onMounted(async () => {
  await import('https://cdn.jsdelivr.net/npm/xcode-graph/dist/xcodegraph.js')
...
<div id="graph-demo" style="width: 100%; height: 600px; border: 1px solid var(--vp-c-border); border-radius: 8px; overflow: hidden;"></div>
